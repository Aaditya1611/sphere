...
const HelpMe = () => {
    ...
    return (
        <div className="h-screen relative lg:overflow-hidden bg-neutral-800">
            ...
            <h1 className="text-center text-2xl my-10 text-neutral-400">
                Advice and answers from the Sphere team
            </h1>
            <div className="my-10 flex justify-center">
                <form className="flex flex-row items-center">
                    <label htmlFor="helpbox"></label>
                    <input className="bg-neutral-500 w-[55rem] h-[4rem] p-5 rounded-l-xl outline-none"
                        type="text"
                        id="searchbox"
                        placeholder="Search your need here"
                    />
                    <div className="bg-neutral-500 h-[4rem] p-5 rounded-r-xl w-[4rem]">
            ...
            <div className="mt-10 flex justify-center">
                <div className="bg-neutral-700 w-[90rem] rounded-xl p-10 overflow-auto">
                    <ol className="list-decimal space-y-6 pl-5 text-neutral-300">
                        <li>
